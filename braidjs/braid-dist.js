...
window.Braid = {
  ...
  identityFromPrivateKey: identityFromPrivateKey,
  randomIdentity: randomIdentity,
  subscribePatches: subscribePatches,
...
function subscribePatches(_x, _x2, _x3, _x4) {
  return _subscribePatches.apply(this, arguments);
}

function _subscribePatches() {
  _subscribePatches = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(host, keypath, parents, cb) {
    var read, headers, res, reader, decoder, buffer;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            function () {
              ...
              regeneratorRuntime.mark(function _callee2() {
                var x, newData, idx, line, payloadStr, payload;
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      ...
                      case 5:
                        newData = decoder.decode(x.value);
                        buffer += newData;
                        ...
                        while ((idx = buffer.indexOf('\n')) > -1) {
                          ...
                          if (line.length > 0) {
                            payloadStr = line.substring(5).trim(); // remove "data:" prefix
          ...
          case 17:
            ...
            console.log('Fetch GET failed:', _context3.t0);
            cb(_context3.t0);
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 7:
            return _context4.abrupt("return", _context4.sent.hash);
...
function serializeTx(tx) {
  var txHex = '';
  txHex += tx.id;
  tx.parents.forEach(function (parent) {
    return txHex += parent;
  });
  txHex += stringToHex(tx.url);
  tx.patches.forEach(function (patch) {
    return txHex += stringToHex(patch);
  });
  return txHex;
}
...
},{"@babel/polyfill":2,"buffer":5,"ethers":310}],2:[function(require,module,exports){
"use strict";
...
},{"./noConflict":3,"core-js/library/fn/global":18}],3:[function(require,module,exports){
"use strict";
...
},{"base64-js":4,"buffer":5,"ieee754":311}],6:[function(require,module,exports){
