...
},{"./braid.transport.http":2,"./braid.transport.webrtc":3,"./dumb-src":4,"./identity":5,"./sync9-src":317,"./utils":318,"@babel/polyfill":6}],2:[function(require,module,exports){
(function (Buffer){
...
function resolve_state(state, sender, txID, parents, patches) {
    for (let pStr of patches) {
		...
		if (p.keys.length > 0) {
            ...
            console.log('typeof getval()', typeof getval())
...
},{"./sync9-src":317}],5:[function(require,module,exports){
...
},{"./utils":318,"ethers":314}],6:[function(require,module,exports){
"use strict";
...
},{"base64-js":8,"buffer":9,"ieee754":315}],10:[function(require,module,exports){
...
},{"./utils":318,"@babel/polyfill":6}],318:[function(require,module,exports){
(function (Buffer){
const ethers = require('ethers')
