...
var (
	testVal1 = M{
		"asdf": []interface{}{"1234", float64(987.2), uint64(333)},
		"flo":  float64(321),
		"flox": []interface{}{
			uint64(65),
	...
	testVal1Output = []fixtureOutput{
		...
		{Keypath("asdf"), NodeTypeSlice, []interface{}{"1234", float64(987.2), uint64(333)}},
		...
		{Keypath("flox"), NodeTypeSlice, []interface{}{uint64(65), M{"yup": "yes", "hey": uint64(321)}, "jkjkjkj"}},
	...
	testVal2 = M{
		...
		"eee": []interface{}{
			M{
				"qqqq": []interface{}{"fjfjjfjf", uint64(123321)},
			},
		},
	}
	testVal2Output = []fixtureOutput{
		{Keypath(nil), NodeTypeMap, testVal2},
		{Keypath("eee"), NodeTypeSlice, []interface{}{M{"qqqq": []interface{}{"fjfjjfjf", uint64(123321)}}}},
		{Keypath("eee").Push(EncodeSliceIndex(0)), NodeTypeMap, M{"qqqq": []interface{}{"fjfjjfjf", uint64(123321)}}},
		{Keypath("eee").Push(EncodeSliceIndex(0)).Push(Keypath("qqqq")), NodeTypeSlice, []interface{}{"fjfjjfjf", uint64(123321)}},
	...
	testVal4 = M{
		"lkjlkj": M{
			"aaa": float64(33),
			"bbb": []interface{}{true, uint64(234), "fjeijfiejf", float64(321)},
		},
		"zzzzz": []interface{}{
			M{"eee": "fff", "ggg": false},
			M{"hhh": true},
