...
func (_m *AuthPeerConn) AddStateURI(stateURI string) error {
...
func (_m *AuthPeerConn) RemoveStateURI(stateURI string) error {
	ret := _m.Called(stateURI)
...
func (_m *AuthPeerConn) SetDeviceUniqueID(id string) error {
	ret := _m.Called(id)
...
func (_m *AuthPeerConn) StateURIs() types.StringSet {
	ret := _m.Called()
