...
func (_m *PeerStore) AddVerifiedCredentials(dialInfo swarm.PeerDialInfo, address types.Address, sigpubkey crypto.SigningPublicKey, encpubkey crypto.AsymEncPubkey) {
