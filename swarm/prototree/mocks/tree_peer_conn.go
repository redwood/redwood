...
func (_m *TreePeerConn) AddStateURI(stateURI string) error {
...
func (_m *TreePeerConn) RemoveStateURI(stateURI string) error {
	ret := _m.Called(stateURI)
...
func (_m *TreePeerConn) SetDeviceUniqueID(id string) error {
	ret := _m.Called(id)
