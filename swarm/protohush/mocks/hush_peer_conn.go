...
func (_m *HushPeerConn) AddStateURI(stateURI string) error {
...
func (_m *HushPeerConn) Addresses() []types.Address {
	ret := _m.Called()
...
func (_m *HushPeerConn) AnnouncePeers(ctx context.Context, peerDialInfos []swarm.PeerDialInfo) error {
...
func (_m *HushPeerConn) RemoveStateURI(stateURI string) error {
	ret := _m.Called(stateURI)
...
func (_m *HushPeerConn) SetDeviceUniqueID(id string) error {
	ret := _m.Called(id)
...
func (_m *HushPeerConn) StateURIs() types.StringSet {
	ret := _m.Called()
