...
var Neutralino = (function (exports) {
                ...
                .then((resp) =>
                    __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (respObj && respObj.success) {
                            resolve(
                                respObj.hasOwnProperty('returnValue')
                                    ? respObj.returnValue
                                    : respObj,
                            )
                        }
                        if (respObj && respObj.error) reject(respObj.error)
                    }),
                )
                .catch((e) => {
                    let error = {
    ...
    function restartProcess(options) {
        return new Promise((resolve, reject) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                yield Neutralino.os.execCommand(command, {
    ...
    function setDraggableRegion(domId) {
        return new Promise((resolve, reject) => {
            ...
            draggableRegion.addEventListener('pointerup', (evt) => {
                draggableRegion.removeEventListener(
                    'pointermove',
                    onPointerMove,
                )
    ...
    function create(url, options) {
        return new Promise((resolve, reject) => {
            ...
            if (options.processArgs) command += ' ' + options.processArgs
            Neutralino.os
                .execCommand({
                    command,
                    shouldRunInBackground: true,
                ...
                () =>
                    __awaiter(void 0, void 0, void 0, function* () {
                        try {
                            ...
                            console.error(
                                'Unable to keep Neutralino server online. The server is not reachable.',
                            )
                        }
                    }),
                PING_INTERVAL_MS,
    ...
    function init() {
        if (window.NL_MODE && window.NL_MODE == 'browser') ping.start()
