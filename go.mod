...
require (
	...
	github.com/brynbellomy/go-luaconv v0.0.0-20191017194522-3988d33620f3
	...
	github.com/status-im/status-go v0.102.2
	github.com/stretchr/testify v1.7.1
	github.com/tetratelabs/wazero v0.0.0-20220620000808-2301afd94bf2
