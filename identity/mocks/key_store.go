...
// OnLoadUser provides a mock function with given fields: fn
func (_m *KeyStore) OnLoadUser(fn identity.UserCallback) {
	_m.Called(fn)
}

// OnSaveUser provides a mock function with given fields: fn
func (_m *KeyStore) OnSaveUser(fn identity.UserCallback) {
	_m.Called(fn)
}

// OpenMessageFrom provides a mock function with given fields: usingIdentity, senderPublicKey, msgEncrypted
func (_m *KeyStore) OpenMessageFrom(usingIdentity types.Address, senderPublicKey crypto.EncryptingPublicKey, msgEncrypted []byte) ([]byte, error) {
	ret := _m.Called(usingIdentity, senderPublicKey, msgEncrypted)

	var r0 []byte
	if rf, ok := ret.Get(0).(func(types.Address, crypto.EncryptingPublicKey, []byte) []byte); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(types.Address, crypto.EncryptingPublicKey, []byte) error); ok {
...
func (_m *KeyStore) SealMessageFor(usingIdentity types.Address, recipientPubKey crypto.EncryptingPublicKey, msg []byte) ([]byte, error) {
